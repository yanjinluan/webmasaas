<template>
    <div class="role-lists-box">
        ...
        <div class="btn-box">
            ...
            <el-button size="mini" @click="offAppAllot">取消</el-button>
        </div>
    </div>
</template>
...
import HaveAppAdmin from './HaveAppAdmin';
...
export default {
    ...
    methods:{
        offAppAllot () {
            //关闭当前窗口
            Bus.$emit('offUserWindow','appallot');
        },
        getUser () {
            //模糊查询方法
        ...
        setAdmin () {
            //设置管理员
            if(this.userId){
                this.$http.put(`/api/platform/applications/${this.appId}/administrators/${this.userId}/`).then( res => {
