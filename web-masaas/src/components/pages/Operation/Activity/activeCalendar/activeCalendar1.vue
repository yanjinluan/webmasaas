...
//                        res.data.resp.records.forEach((currentValue)=>{
////                             console.log(currentValue.startTime.substr(0,10));
//                             this.actDate.push(currentValue.startTime.substr(0,10))
//
//                        });
//                        console.log( this.actDate);
//                        this.days.forEach((currentValue)=>{
//                            var dt=new Date(currentValue.day);
//                            var y=dt.getFullYear()
//                            var m=(dt.getMonth()+1).toString().padStart(2,'0');
//                            var d=(dt.getDate()).toString().padStart(2,'0');
//                             currentValue=y+'-'+m+'-'+d;
//                             this.allDate.push(currentValue);
//
//                         });
////                        console.log(this.allDate.toString());
//                        var result = new Array();
//
////                        var c=b.toString();
//                        for(var i=0;i<this.actDate.length;i++)
//                        {
//                            if(this.allDate.toString().indexOf(this.actDate[i].toString())>-1)
//                            {
//                                result.push(this.actDate[i]);
//                            }
//                        }
//
//                        console.log(result)
